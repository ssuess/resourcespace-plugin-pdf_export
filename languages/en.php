...
$lang["pdf_export_fields_exclude"]="Fields to exclude from the export<br />(use ref IDs of <a href='/pages/admin/admin_resource_type_fields.php'>metadata fields</a>, comma separated)<br /><br />";
...
$lang['pdf_export_whereabouts_integration']="whereabouts plugin integration?<br/>(includes current whereabouts in list)<br /><br />";
